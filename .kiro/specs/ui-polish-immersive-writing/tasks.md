...
- [x] 1. Create FocusModeStore and shared infrastructure
  - [x] 1.1 Create the FocusModeStore Zustand slice with localStorage persistence
  ...
  - [x] 1.3 Create the `useFullscreen` hook with graceful degradation
  ...
  - [x] 1.4 Create the `useToolbarVisibility` hook
...
- [x] 2. Dashboard polish — minimal CSS fixes
  - [x] 2.1 Fix stat cards, world cards, activity feed, and quick actions
...
- [x] 3. Settings page redesign — tabbed navigation
  - [x] 3.1 Create the SettingsLayout component with tab navigation
  ...
  - [x] 3.2 Create the PreferencesTab with Writing Preferences section
  ...
  - [x] 3.3 Refactor settings page to use SettingsLayout
...
- [x] 5. Immersive writing mode — core components
  - [x] 5.1 Create the AmbientLayer component
  ...
  - [x] 5.2 Create the ImmersiveToolbar component
  ...
  - [x] 5.3 Create the `useImmersiveKeyboard` hook
...
- [x] 6. Immersive writing mode — portal and integration
  - [x] 6.1 Create the ImmersivePortal component
  ...
  - [x] 6.2 Implement paragraph focus mode in the immersive editor
  ...
  - [x] 6.4 Integrate ImmersivePortal into LoomEditor
